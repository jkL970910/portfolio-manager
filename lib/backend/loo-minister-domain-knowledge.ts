...
export const looMinisterPageLabels: Record<
  LooMinisterPageContext["page"],
  string
> = {
  overview: "总览",
  portfolio: "组合",
...
export const looMinisterProjectKnowledgeItems: Array<{
  ...
  },
  {
    ...
    value:
      "推荐页当前是 V2.1 deterministic core + V3 cached-intelligence overlay。",
    detail:
  ...
  },
  {
    ...
    value:
      "AI 大臣是跨页面 Loo国管家，用当前页面 DTO、用户偏好、推荐、缓存分析和对话上下文回答问题。",
    detail:
...
export function searchLooMinisterProjectKnowledge(input: {
  ...
  const unique = new Map<
    string,
    (typeof looMinisterProjectKnowledgeItems)[number]
  >();
