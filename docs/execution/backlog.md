...
| 3    | Backend contract typing for Flutter           | In Progress | Settings market-data refresh plus Overview / Portfolio snapshots are typed; continue moving Import / Recommendations / Settings preferences away from page-level Map parsing. |
...
3. Continue mobile DTO typing: Import / Recommendations / Settings preferences next, then detail-page DTO depth.
