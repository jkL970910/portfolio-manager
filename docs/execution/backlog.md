...
| ---- | --------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | P0.5 real-data AI / external consultation     | In Progress | Before UI overhaul, make 智能标的分析, AI 大臣, and the portfolio-analyzer skill consume trustworthy cached quote/history/FX/provider data with explicit freshness/source boundaries. |
...
| 3    | Recommendation V3 external intelligence       | In Progress | V3 overlay now surfaces cached intelligence, market pulse, and preference-fit explanations on top of deterministic V2.1; next is calibrated scoring from cached external documents.                  |
