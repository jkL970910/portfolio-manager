...
| HoldingTable | stable | [holding-table.tsx](E:\Projects\Portfolio%20Manager\components\portfolio\holding-table.tsx) | Shared holdings detail table with optional deep-link highlight state, a whole symbol block that opens holding detail, clear hover affordance, and an explicit split between share of total portfolio and share inside the current account |
