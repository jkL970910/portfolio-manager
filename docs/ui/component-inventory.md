...
| DonutChartCard | stable | [donut-chart.tsx](E:\Projects\Portfolio%20Manager\components\charts\donut-chart.tsx) | Shared donut chart shell with active-slice emphasis and slice hover tooltips, explicit suppression of chart labels so sticky rails stay clean, compact size options for narrower right-rail stacks, reduced internal spacing for summary-sized donut cards, and an optional compact side legend for fixed distribution labels when a right-rail summary needs always-visible context |
...
| PortfolioSecurityDetailPage | domain | [page.tsx](E:\Projects\Portfolio%20Manager\app\portfolio\security\[symbol]\page.tsx) | Read-only security brief for recommended or already-held symbols, using the shared detail-overview pattern: left identity-plus-trend overview, right compact metrics, quote-source facts, and related portfolio holdings when applicable |
| Detail overview pattern | stable | [account page](E:\Projects\Portfolio%20Manager\app\portfolio\account\[accountId]\page.tsx), [holding page](E:\Projects\Portfolio%20Manager\app\portfolio\holding\[holdingId]\page.tsx), [security page](E:\Projects\Portfolio%20Manager\app\portfolio\security\[symbol]\page.tsx) | Shared first-fold layout for detail pages: left overview story with identity and 6-month trend, right compact metrics only, no repeated ratio/gain-loss facts immediately restated below, a consistent title-row where the key pills sit directly to the right of the title, on account detail the account-internal donut lives in the right-side summary stack with a fixed-width ring plus compact side legend, and compact metric values should be rendered as the shortest useful value rather than full explanatory phrases |
