...
| Recommendations input summary | domain | [recommendations/page.tsx](E:\Projects\Portfolio%20Manager\app\recommendations\page.tsx) | Top-of-page context block that separates the saved funding order from the usable order for this contribution, weakens or warns on sheltered accounts whose room is exhausted, and keeps Chinese copy in `Loo皇审核` tone while English stays neutral |
