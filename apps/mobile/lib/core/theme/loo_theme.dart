...
const looLightTokens = LooThemeTokens(
  ...
  cardBorder: Color(0x33A44961),
  mutedText: Color(0xFF6F4D58),
  subtleText: Color(0xFF9C7783),
  accent: Color(0xFFD83D6C),
  accentSoft: Color(0x22D83D6C),
  success: Color(0xFF218B58),
  warning: Color(0xFFAA6B00),
  danger: Color(0xFFC23342),
  info: Color(0xFF2E69C7),
  radiusSm: 12,
  radiusMd: 16,
  radiusLg: 22,
  radiusXl: 30,
...
ThemeData buildLooLightTheme() {
  return _buildLooTheme(
    ...
    primary: const Color(0xFFD83D6C),
    onSurface: const Color(0xFF25151B),
  );
}
  ...
  return ThemeData(
    ...
    colorScheme: scheme.copyWith(
      ...
      surfaceContainerHighest:
          isDark ? const Color(0xFF321722) : const Color(0xFFFFEEF2),
